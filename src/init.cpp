...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-datacarriersize", strprintf(_("Maximum size of data in data carrier transactions we relay and mine (default: %u)"), MAX_OP_REPORT_RELAY));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/aprnets/aprncoin>";
    const std::string URL_WEBSITE = "<https://aprnets.com>";
