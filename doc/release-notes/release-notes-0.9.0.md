...
OP_REPORT and data in the block chain
-------------------------------------
On OP_REPORT:  There was been some confusion and misunderstanding in
the community, regarding the OP_REPORT feature in 0.9 and data in the
blockchain.  This change is not an endorsement of storing data in the
blockchain.  The OP_REPORT change creates a provably-prunable output,
...
- Relay OP_REPORT data TxOut as standard transaction type
