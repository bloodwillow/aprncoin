...
* Update manpages, see [gen-manpages.sh](https://github.com/aprnets/aprncoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [aprncoin-detached-sigs](https://github.com/aprnets/aprncoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the aprnets.com server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the aprnets.com server.

```

- Update aprnets.com version

- Announce the release:

  - aprncoin-dev and aprncoin-dev mailing list

  - blog.aprnets.com blog post
  ...
  - Create a [new GitHub release](https://github.com/aprnets/aprncoin/releases/new) with a link to the archived release notes.
