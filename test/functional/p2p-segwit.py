...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_witness_commitments(self):
        ...
        # Add an extra OP_REPORT output that matches the witness commitment template,
        # even though it has extra data after the incorrect commitment.
        # This block should fail.
        block_3.vtx[0].vout.append(CTxOut(0, CScript([OP_REPORT, WITNESS_COMMITMENT_HEADER + ser_uint256(2), 10])))
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # aprncoin: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def run_test(self):
        ...
        # aprncoin: Disable test due to occasional travis issue
